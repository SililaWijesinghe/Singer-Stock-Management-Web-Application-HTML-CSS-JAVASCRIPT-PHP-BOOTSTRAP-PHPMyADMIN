...
<header>
		<style>
			body {
    background: url("https://www.singerslfiles.com/images/singer-logos/singer_logo_red_whiteout_square_bk_transparent.png") center/cover fixed; /* Replace with your background image */
}
